...
output: 
  revealjs::revealjs_presentation:
    ...
    reveal_options:
      slideNumber: true
      previewLinks: true
author: DOÇ. DR. BURAK AYDIN - EGE ÜNİVERSİTESİ
...
## SİZCE DÜNYADA TEKRARLANABİLİRLİK KRİZİ VAR MI?

- Üç seçenekten birini kullanabilirsiniz

  + [Link](https://www.menti.com/wdwgzd68a1) 

  + www.menti.com adresinde  76 41 16 0 kodu
...
::: notes
%52 kesinlikle evet
%38 evet yani toplam %90
%7 bilmiyorum
Toplam 1576 katılımcı
:::
...
- S1. Çalışmalarda evren tanımı ve örneklem seçimi nedir?
...
Tahminleyici önemli hem kategori doğa hem etkili gözlemlere direnç.
:::
...
- Sunum RStudio paketi revealjs ile hazırlanmıştır (Hattab & Allaire, 2017)
